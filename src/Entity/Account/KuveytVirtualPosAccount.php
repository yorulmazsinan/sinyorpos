...
/**
 * KuveytVirtualPosAccount
 */
class KuveytVirtualPosAccount extends AbstractPosAccount
{
	/**
	...
	public function __construct(
		string $bank, string $merchantId, string $username, string $customerId, string $storeKey, string $model, string $lang, ?string $subMerchantId = null)
	{
