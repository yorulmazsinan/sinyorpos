...
/**
 * GarantiVirtualPosAccount
 */
class GarantiVirtualPosAccount extends AbstractPosAccount
{
	/**
	 * @var string
	 */
	...
	public function __construct(
		string $bank, string $model, string $merchantId, string $username, string $password, string $lang, string $terminalId, ?string $storeKey = null, ?string $refundUsername = null, ?string $refundPassword = null)
	{
