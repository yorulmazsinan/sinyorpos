...
/**
 * Class PayForVirtualPos
 */
class PayForVirtualPos extends AbstractGateway
{
	/**
	 * @const string
	 */
	...
	/**
	 * @var PayForVirtualPosRequestDataMapper
	 */
	protected $requestDataMapper;

	/**
	 * @param PayForVirtualPosAccount $account
	 * @param PayForVirtualPosRequestDataMapper $requestDataMapper
	 */
