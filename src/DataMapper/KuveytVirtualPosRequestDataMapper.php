 ...
 */
class KuveytVirtualPosRequestDataMapper extends AbstractRequestDataMapper
{
	...
	protected $secureTypeMappings = [
		...
		//TODO: Boş değerleri, geçerli değerlerle güncelle.
	 ...
	 * @return array
	 */
	public function create3DEnrollmentCheckRequestData(KuveytVirtualPosAccount $account, $order, string $txType, ?AbstractCreditCard $card = null): array
	{
